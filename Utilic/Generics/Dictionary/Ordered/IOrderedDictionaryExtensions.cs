namespace GSR.Utilic.Generic
{
    ...
    {
        /// <summary>
        /// Create a mutable <see cref="IOrderedDictionary{TKey, TValue}"/> containing the <see cref="KeyValuePair"/>s.
        /// </summary>
        ...
        /// <summary>
        /// Create an immutable <see cref="IOrderedDictionary{TKey, TValue}"/> containing the <see cref="KeyValuePair"/>s.
        /// </summary>
        /// <typeparam name="TKey"></typeparam>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="kvps"></param>
